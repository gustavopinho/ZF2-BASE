...
class Resource extends \Acl\Entity\Resource implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Acl\\Entity\\Resource' . "\0" . 'id', '' . "\0" . 'Acl\\Entity\\Resource' . "\0" . 'name', '' . "\0" . 'Acl\\Entity\\Resource' . "\0" . 'created', '' . "\0" . 'Acl\\Entity\\Resource' . "\0" . 'updated');
        }
